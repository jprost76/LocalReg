...
parser.add_argument("--std", type=int, default=7, help="noise standard deviation (int) in range [0-255] (default : 7)")
...
parser.add_argument("-l", type=float, default=0.1, help="regularization parameter (default=0.1)")
